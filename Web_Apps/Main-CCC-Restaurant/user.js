...
// });
        ...
        function displayItems(){
            ...
            const biryaniData= items_db.filter((item)=>item.category=='biryani');
            const chickenData= items_db.filter((item)=>item.category=='chicken');
        ...
        document.getElementById('side-menu-orders').addEventListener('click',cartToggle);
        document.getElementById('side-menu-cart').addEventListener('click',cartToggle);
        document.getElementById('side-menu-checkout').addEventListener('click',cartToggle);
