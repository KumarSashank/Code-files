...
def set_audio_balance(left_balance, right_balance):
    try:
        ...
        ca_framework.AudioObjectGetPropertyData(0, 0, 0, ctypes.byref(size), ctypes.byref(default_output_id))
        ...
        ca_framework.AudioObjectSetPropertyData(default_output_id, ctypes.byref(kAudioObjectPropertyScopeOutput),
                                                0, 0, size, balance_values_ptr)
