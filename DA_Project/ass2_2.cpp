//Non Recursive program for Tower of Hanoi.
...
int main()
{
    ...
    {
        temp = 1;
    } //temp=1 for starting from A to C
    ...
    for (int i = 1; i <= total_steps; i++)
    {
        for (int x = 0; x < discs; x++)
        {
            ...
            if (i == condition)
            {
                ...
                cout << "Move disc " << x + 1 << " from " << source << " to " << dest << endl;
                Total_Moves++;
                continue;
            }
        }
    ...
    cout << endl
         << "Total number of moves are : " << Total_Moves << endl;
